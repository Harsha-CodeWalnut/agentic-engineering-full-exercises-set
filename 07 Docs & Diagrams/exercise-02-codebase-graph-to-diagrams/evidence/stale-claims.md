...
Claims are listed in `docs/graph-snapshot.md` order. The generated graph at source SHA `1ee294aa42661dcc8eda3c5956c28381b7731bfd` is the machine-readable record; `selectNotificationRoute` is the behavior authority.
