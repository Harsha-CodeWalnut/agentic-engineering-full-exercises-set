...
After: scenario trace PASS for normal, highRisk, and failure; Mermaid parser PASS; semantic verifier and `npm run verify:exercise` are the final coverage gate for the source-led branch.
