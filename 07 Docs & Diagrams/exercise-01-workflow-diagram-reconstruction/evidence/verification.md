...
Source SHA: `b238b21fbe6b7b22e367d2dc9a1d8696389225fb`.
...
Semantic verifier: `npm run diagrams:verify` is run as part of `npm run verify:exercise`. Required states, routes, actors, condition labels, and `%% EDGE` markers must match the protected contract.
